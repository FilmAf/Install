...
# *** EH restoring ')no-repeat 50%50%' to ') no-repeat 50% 50%'
#	$content =~ s/\)no-repeat/\) no-repeat/gs;
#	$content =~ s/([0-9]{1,2})%([0-9]{1,2})%/$1% $2%/gs;
	$content =~ s/\)([a-zA-z0-9])/\) $1/gs;
	$content =~ s/([0-9]{1,2})%([a-zA-Z0-9])/$1% $2/gs;
